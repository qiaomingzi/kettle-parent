...
public class Launcher {
  public static void main(String[] args ) throws Exception {
    if(args == null || args.length == 0) {
      /*args = new String[]{"-main","org.pentaho.di.ui.spoon.Spoon",
               "-libraries","../test:../lib:../libswt/win64",
               "-classpath","../:../ui:../ui/images:../lib"
       };*/
      args = new String[]{"-main","org.pentaho.di.ui.spoon.Spoon",
              "-libraries","../test:../libswt/win64",
    ...
    //final Class<?> mainClass = cl.loadClass("org.pentaho.di.ui.spoon.Spoon");
    // Invoke main(..)
